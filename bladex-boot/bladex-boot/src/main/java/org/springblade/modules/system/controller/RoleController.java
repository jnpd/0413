...
public class RoleController extends BladeController {
	...
	@Operation(summary = "分页", description = "角色分页")
	public R<IPage<RoleVO>> page(RoleVO role, Query query, BladeUser bladeUser) {
		role.setTenantId(Func.toStrWithEmpty(role.getTenantId(), bladeUser.getTenantId()));
		if (!AuthUtil.isAdmin() && !AuthUtil.isAdministrator()) {
			role.setExcludeRoleAliases(Arrays.asList(
